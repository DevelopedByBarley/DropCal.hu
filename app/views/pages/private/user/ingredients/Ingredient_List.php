                    ...
                    <tbody>
                        <?php foreach ($params["ingredients"] as $ingredient) : ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop<?= $ingredient["ingredientId"] ?>">
                                        <i class="bi bi-trash"></i>
                                    </button>
                                </td>
                                <td>
                                    <a href="/ingredient/update?id=<?= $ingredient["ingredientId"] ?>" class="btn btn-warning text-light">
                            ...
                            <div class="modal fade" id="staticBackdrop<?= $ingredient["ingredientId"] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
